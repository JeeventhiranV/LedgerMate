...
(function () {
  ...
  var LM_StockRegistry = {
    ...
    getReferenceQuote: function (symbol, exchange) {
      ...
      // Common reference baseline prices for Indian bluechips & popular equities
      var BASELINE_PRICES = {
        'RELIANCE': { price: 2980.50, prev: 2950.00 },
        'TCS': { price: 3880.00, prev: 3855.00 },
        'HDFCBANK': { price: 1675.50, prev: 1662.00 },
        'INFY': { price: 1820.25, prev: 1805.00 },
        'ICICIBANK': { price: 1260.00, prev: 1248.00 },
        'BHARTIARTL': { price: 1640.00, prev: 1625.00 },
        'SBIN': { price: 825.50, prev: 815.00 },
        'ITC': { price: 428.50, prev: 424.00 },
        'LT': { price: 3680.00, prev: 3640.00 },
        'HINDUNILVR': { price: 2750.00, prev: 2735.00 },
        'BAJFINANCE': { price: 7420.00, prev: 7350.00 },
        'HCLTECH': { price: 1780.00, prev: 1760.00 },
        'MARUTI': { price: 12450.00, prev: 12380.00 },
        'SUNPHARMA': { price: 1860.00, prev: 1845.00 },
        'TATAMOTORS': { price: 980.00, prev: 968.00 },
        'KOTAKBANK': { price: 1840.00, prev: 1825.00 },
        'AXISBANK': { price: 1230.00, prev: 1218.00 },
        'NTPC': { price: 412.00, prev: 406.00 },
        'ONGC': { price: 320.00, prev: 315.00 },
        'TITAN': { price: 3740.00, prev: 3710.00 },
        'ADANIENT': { price: 3150.00, prev: 3110.00 },
        'ADANIPORTS': { price: 1480.00, prev: 1460.00 },
        'BAJAJFINSV': { price: 1890.00, prev: 1870.00 },
        'POWERGRID': { price: 340.00, prev: 335.00 },
        'TATASTEEL': { price: 158.50, prev: 155.00 },
        'M&M': { price: 2820.00, prev: 2780.00 },
        'COALINDIA': { price: 510.00, prev: 502.00 },
        'WIPRO': { price: 535.00, prev: 528.00 },
        'ASIANPAINT': { price: 2950.00, prev: 2920.00 },
        'ULTRACEMCO': { price: 11400.00, prev: 11250.00 },
        'JSWSTEEL': { price: 985.00, prev: 972.00 },
        'NESTLEIND': { price: 2540.00, prev: 2515.00 },
        'GRASIM': { price: 2740.00, prev: 2710.00 },
        'TECHM': { price: 1620.00, prev: 1600.00 },
        'HINDALCO': { price: 685.00, prev: 674.00 },
        'CIPLA': { price: 1580.00, prev: 1560.00 },
        'DRREDDY': { price: 6720.00, prev: 6650.00 },
        'HEROMOTOCO': { price: 5890.00, prev: 5820.00 },
        'BRITANNIA': { price: 5950.00, prev: 5910.00 },
        'EICHERMOT': { price: 4920.00, prev: 4860.00 },
        'APOLLOHOSP': { price: 6850.00, prev: 6790.00 },
        'TATACONSUM': { price: 1180.00, prev: 1165.00 },
        'DIVISLAB': { price: 5120.00, prev: 5060.00 },
        'INDUSINDBK': { price: 1460.00, prev: 1445.00 },
        'BPCL': { price: 360.00, prev: 354.00 },
        'SBILIFE': { price: 1840.00, prev: 1820.00 },
        'HDFCLIFE': { price: 730.00, prev: 720.00 },
        'BAJAJ-AUTO': { price: 11800.00, prev: 11650.00 },
        'SHRIRAMFIN': { price: 3280.00, prev: 3230.00 },
        'TRENT': { price: 7420.00, prev: 7280.00 },
        'BEL': { price: 310.00, prev: 304.00 },
        'HAL': { price: 4720.00, prev: 4650.00 },
        'ZOMATO': { price: 275.00, prev: 268.00 },
        'JIOFIN': { price: 350.00, prev: 345.00 },
        'VEDL': { price: 470.00, prev: 462.00 },
        'TATAPOWER': { price: 440.00, prev: 432.00 },
        'IRFC': { price: 175.00, prev: 171.00 },
        'PFC': { price: 520.00, prev: 512.00 },
        'RECLTD': { price: 580.00, prev: 572.00 },
        'IOC': { price: 178.00, prev: 175.00 },
        'GAIL': { price: 235.00, prev: 230.00 },
        'DLF': { price: 880.00, prev: 868.00 },
        'VBL': { price: 620.00, prev: 610.00 },
        'SIEMENS': { price: 7250.00, prev: 7160.00 },
        'ABB': { price: 8300.00, prev: 8180.00 },
        'BSE': { price: 4150.00, prev: 4050.00 },
        'CDSL': { price: 1540.00, prev: 1510.00 },
        'SUZLON': { price: 78.50, prev: 76.80 },
        'IREDA': { price: 235.00, prev: 229.00 },
        'RVNL': { price: 580.00, prev: 568.00 },
        'MAZDOCK': { price: 4450.00, prev: 4360.00 },
        'COCHINSHIP': { price: 1890.00, prev: 1840.00 },
        'PAYTM': { price: 685.00, prev: 672.00 },
        'NYKAA': { price: 215.00, prev: 210.00 },
        'POLICYBZR': { price: 1740.00, prev: 1710.00 }
      };

      var data = BASELINE_PRICES[sym];
      if (data) {
        var diff = data.price - data.prev;
        var pct = data.prev > 0 ? (diff / data.prev) * 100 : 0;
        return {
          symbol: sym,
          exchange: ex,
          price: data.price,
          previous_close: data.prev,
          change: Math.round((diff + Number.EPSILON) * 100) / 100,
          change_percent: Math.round((pct + Number.EPSILON) * 100) / 100,
          currency: 'INR',
          market_status: 'REFERENCE',
          timestamp: Date.now(),
          isLive: false
        };
      }
